...
// beacuse of this keyword we can access the properties and methods of an object
...
// this keyboard context is determined by how a function is called
// (that is the reason why this keyword is called dynamic scope) (this
// ni value this nu use kaya context ma che te par depend kare chhe)
...
let a = {
    ...
    write: function () {
        ...
        // method --> ek function je koi object ni under hoy tene method kevay.
        // this --> give object
        // if you use arrow function then this key give you windows object
        ...
        // looses her value --> solution --> you have to create a arrow
        // function
...
let c = {
  ...
  write: function () {
    function abc() {
      console.log("method -- fnc es5 ==> fnc es5", this);
    }
    abc();
  },
};
...
let d = {
  ...
  write: function () {
    let bcd=()=> {
      console.log("method -- > es5 ==>  es6", this);
    }
    bcd();
  },
};
...
//method context with es 5 fnc -->object
//method context with es 6 fnc -->window
...
//Manual Binding
//call ,apply ,bind
//function ne call karti vakhte this keyword ni value set karva mate call ,apply ,bind no upyog kariye chhiye 
...
// function.bind(object_name) --> this keyword ni value set karva mate bind method no upyog kariye chhiyelet
