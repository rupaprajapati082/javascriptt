...
return {
 ...
 // Factory Function Pattern Ek function banavo chho, je objects create kare chhe (factory = objects banava nu machine)
    ...
    return{
        ...
        buy(qty){
            if(qty<stock){
                ...
                console.error(`We Dont have these many pieces. ${stock}`);
            }
...
let samsung = createProduct("S26 Ultra",150000,"Samsung");
...
class Youtube{
    ...
    subscribe(user){
        this.subscribers.push(user)
            console.log(`you have new subscribers ${user.name}`)
    }
}
class User{
constructor(name){
...
let sub = new User("rups prajapati");
