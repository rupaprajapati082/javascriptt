...
function showUser(){
    ...
    //    console.log(data); 
       //create card
//div(card)-->img(pic)-->div(blur)->div(content)[h2,p(card-text)]
...
inp.addEventListener("input",  () =>{
    ...
    let text=inp.value;
    return data.name.startsWith(text);//data mate true ave te data return save thase 
    });
